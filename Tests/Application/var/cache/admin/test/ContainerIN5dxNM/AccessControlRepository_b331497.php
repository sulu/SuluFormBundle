...
class AccessControlRepository_b331497 extends \Sulu\Bundle\SecurityBundle\Entity\AccessControlRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findByTypeAndIdAndRole', array('type' => $type, 'id' => $id, 'roleId' => $roleId), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findByTypeAndIdAndRole($type, $id, $roleId);
    }

    public function findByTypeAndId($type, $id)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findByTypeAndId', array('type' => $type, 'id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findByTypeAndId($type, $id);
    }
