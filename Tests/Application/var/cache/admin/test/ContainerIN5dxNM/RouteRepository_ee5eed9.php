...
class RouteRepository_ee5eed9 extends \Sulu\Bundle\RouteBundle\Entity\RouteRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findByPath', array('path' => $path, 'locale' => $locale), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findByPath($path, $locale);
    }

    public function findByEntity($entityClass, $entityId, $locale)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findByEntity($entityClass, $entityId, $locale);
    }

    public function findHistoryByEntity($entityClass, $entityId, $locale)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findHistoryByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findHistoryByEntity($entityClass, $entityId, $locale);
    }

    public function findAllByEntity($entityClass, $entityId, $locale = null)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAllByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAllByEntity($entityClass, $entityId, $locale);
    }
