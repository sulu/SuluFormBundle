...
class UserRepository_28384ec extends \Sulu\Bundle\SecurityBundle\Entity\UserRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUsersByAccount', array('accountId' => $accountId, 'sortBy' => $sortBy), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUsersByAccount($accountId, $sortBy);
    }

    public function findUserById($id)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserById', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserById($id);
    }

    public function findUsersById(array $ids)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUsersById', array('ids' => $ids), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUsersById($ids);
    }

    public function findUserByContact($id)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserByContact', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserByContact($id);
    }

    public function findUserByUsername($username)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserByUsername', array('username' => $username), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserByUsername($username);
    }

    public function findAllUsersByRoleId($roleId)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAllUsersByRoleId', array('roleId' => $roleId), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAllUsersByRoleId($roleId);
    }

    public function findUserByEmail($email)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserByEmail', array('email' => $email), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserByEmail($email);
    }

    public function findUserByToken($token)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserByToken', array('token' => $token), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserByToken($token);
    }

    public function findUserByIdentifier($identifier)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserByIdentifier', array('identifier' => $identifier), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserByIdentifier($identifier);
    }

    public function findUserWithSecurityById($id)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserWithSecurityById', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserWithSecurityById($id);
    }

    public function getUsernameByApiKey($apiKey)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'getUsernameByApiKey', array('apiKey' => $apiKey), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->getUsernameByApiKey($apiKey);
    }

    public function findUserBySystem($system)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findUserBySystem', array('system' => $system), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findUserBySystem($system);
    }
