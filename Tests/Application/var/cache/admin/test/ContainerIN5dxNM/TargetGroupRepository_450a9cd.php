...
class TargetGroupRepository_450a9cd extends \Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    public function save(\Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupInterface $targetGroup)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'save', array('targetGroup' => $targetGroup), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->save($targetGroup);
    }
    ...
    public function findAllActiveForWebspaceOrderedByPriority($webspace, $maxFrequency = 3)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAllActiveForWebspaceOrderedByPriority', array('webspace' => $webspace, 'maxFrequency' => $maxFrequency), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAllActiveForWebspaceOrderedByPriority($webspace, $maxFrequency);
    }
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolder7e055) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\AudienceTargetingBundle\\Entity\\TargetGroupRepository');
