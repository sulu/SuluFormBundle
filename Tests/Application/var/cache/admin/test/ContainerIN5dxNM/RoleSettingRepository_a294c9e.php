...
class RoleSettingRepository_a294c9e extends \Sulu\Bundle\SecurityBundle\Entity\RoleSettingRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findSettingValue', array('roleId' => $roleId, 'key' => $key), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findSettingValue($roleId, $key);
    }

    public function findSetting($roleId, $key)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findSetting', array('roleId' => $roleId, 'key' => $key), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findSetting($roleId, $key);
    }
