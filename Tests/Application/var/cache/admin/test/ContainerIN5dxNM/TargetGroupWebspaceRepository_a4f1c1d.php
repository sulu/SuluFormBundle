...
class TargetGroupWebspaceRepository_a4f1c1d extends \Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupWebspaceRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    public function findOrCreate(\Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupInterface $targetGroup, $webspaceKey)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findOrCreate', array('targetGroup' => $targetGroup, 'webspaceKey' => $webspaceKey), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findOrCreate($targetGroup, $webspaceKey);
    }

    public function remove(\Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupWebspaceInterface $targetGroupWebspace)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'remove', array('targetGroupWebspace' => $targetGroupWebspace), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->remove($targetGroupWebspace);
    }
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolder7e055) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\AudienceTargetingBundle\\Entity\\TargetGroupWebspaceRepository');
