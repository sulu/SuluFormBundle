...
class TargetGroupRuleRepository_a625f53 extends \Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupRuleRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    public function save(\Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupRuleInterface $targetGroupRule)
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'save', array('targetGroupRule' => $targetGroupRule), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->save($targetGroupRule);
    }
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolder7e055) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\AudienceTargetingBundle\\Entity\\TargetGroupRuleRepository');
