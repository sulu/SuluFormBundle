...
class KeywordRepository_4891058 extends \Sulu\Bundle\CategoryBundle\Entity\KeywordRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findByKeyword', array('keyword' => $keyword, 'locale' => $locale), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findByKeyword($keyword, $locale);
    }
