...
class AccountRepository_21f7ad1 extends \Sulu\Bundle\ContactBundle\Entity\AccountRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findOneByContactId', array('contactId' => $contactId), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findOneByContactId($contactId);
    }

    public function findAccountOnly(int $id) : ?\Sulu\Bundle\ContactBundle\Entity\AccountInterface
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAccountOnly', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAccountOnly($id);
    }

    public function findAccountById(int $id, bool $contacts = false) : ?\Sulu\Bundle\ContactBundle\Entity\AccountInterface
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAccountById', array('id' => $id, 'contacts' => $contacts), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAccountById($id, $contacts);
    }
    ...
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findByFilter', array('filter' => $filter), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findByFilter($filter);
    }

    public function findAllSelect(array $fields = []) : array
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAllSelect', array('fields' => $fields), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAllSelect($fields);
    }

    public function findAccountByIdAndDelete(int $id) : ?\Sulu\Bundle\ContactBundle\Entity\AccountInterface
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findAccountByIdAndDelete', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findAccountByIdAndDelete($id);
    }

    public function countDistinctAccountChildrenAndContacts(int $id) : array
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'countDistinctAccountChildrenAndContacts', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->countDistinctAccountChildrenAndContacts($id);
    }

    public function findChildrenAndContacts(int $id) : ?\Sulu\Bundle\ContactBundle\Entity\AccountInterface
    {
        $this->initializer1ad21 && ($this->initializer1ad21->__invoke($valueHolder7e055, $this, 'findChildrenAndContacts', array('id' => $id), $this->initializer1ad21) || 1) && $this->valueHolder7e055 = $valueHolder7e055;

        return $this->valueHolder7e055->findChildrenAndContacts($id);
    }
