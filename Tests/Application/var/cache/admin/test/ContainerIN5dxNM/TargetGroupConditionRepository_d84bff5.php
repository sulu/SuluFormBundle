...
class TargetGroupConditionRepository_d84bff5 extends \Sulu\Bundle\AudienceTargetingBundle\Entity\TargetGroupConditionRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolder7e055) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\AudienceTargetingBundle\\Entity\\TargetGroupConditionRepository');
