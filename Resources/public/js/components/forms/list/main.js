...
define(['l91suluform/collections/forms'], function (Collection) {
    ...
    var constants = {
        ...
        listId: 'form-list',
        lastClickedEventSettingsKey: 'l91suluformformLastClicked',
        endPointUrl: collection.url(),
        toolbarKey: 'forms',
        toolbarSearchFields: ['title'],
        fieldsAction: collection.fieldsUrl(),
        eventPrefix: 'l91.sulu.form.forms.',
        translatePrefix: 'l91_sulu_form.forms.'
    };
