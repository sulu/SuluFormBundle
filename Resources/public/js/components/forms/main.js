...
define(['l91suluform/model/form',
    'l91suluform/collections/forms'], function (Model,  Collection) {
    ...
    var constants = {
        ...
        rootUrl: 'l91/forms/',
        defaultTab: 'general',
        formModule: 'forms/form@l91suluform',
        listModule: 'forms/list@l91suluform'
    },

    namespace = 'l91.sulu.form.forms.',

    /**
     * listens on and navigates to entity list
     * @event l91.sulu.form.forms.list
     */
     ...
     * @event l91.sulu.form.forms.changed
     ...
     * @event l91.sulu.form.forms.save
     ...
     * @event l91.sulu.form.forms.delete
     ...
     * @event l91.sulu.form.forms.deleted
