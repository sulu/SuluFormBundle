...
return static function(ContainerConfigurator $container) {
    ...
    $services->set('sulu_form.mailchimp_list_subscriber', MailchimpListSubscriber::class)
        ->args([
    ...
    $services->set('sulu_form.mailchimp_list_select_controller', MailchimpListSelectController::class)
        ->public()
